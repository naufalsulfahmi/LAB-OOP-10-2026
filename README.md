...
# Repositori Tugas Lab Pemrograman Berorientasi Objek 2026
...
2. **Clone** repositori hasil **fork** anda
   ...
   git clone https://github.com/YOUR_USERNAME/LAB-OOP-10-2026.git
...
8. Setelah asistensi dan tugas anda disetujui, **push** seluruh _file_ jawaban yang telah anda buat
   ...
   #6. Tuliskan note untuk token anda (ex: Token for Lab-OOP-2026)
